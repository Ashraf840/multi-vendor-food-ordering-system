    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('restaurant_name', models.CharField(blank=True, max_length=100, null=True, unique=True)),
                ('restaurant_id', models.CharField(blank=True, max_length=150, null=True)),
                ('tin_number', models.CharField(blank=True, max_length=50, null=True, unique=True)),
                ('rest_profile_pic', models.ImageField(blank=True, null=True, upload_to='profilePicture')),
